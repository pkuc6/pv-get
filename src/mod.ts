...
async function getHQYCookie(lessonId: string, long: string, cookie: string) {
...
async function getLessonInfo(hqyCookie: string, lessonId: string, courseId: string, courseFolder: string) {
